...
<html>
<head>
  <title>Study Central | Home Page</title>
  <link href=
...
<body>
  <?php include 'inc/header.php';?>
      <script type="text/javascript">
        ...
        mf.src = "//cdn.mouseflow.com/projects/38125457-af82-4608-a887-04b6a662877e.js";
    ...
    <table class="classStudyTable">
      ...
      <tr class="studyGuideRow">
        <td class="studyGuideInfoCol">
		  ...
		  <?php $recentLink = $recent['submitLink']; ?>
		  <td><ul class="share-buttons">
			<li><a  href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $recent['submitLink']; ?>" title="Share on Facebook" target="_blank" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<?php echo $recent['submitLink']; ?>'); return false;"><img class="imgrotate" src="images/flat_web_icon_set/color/Facebook.png"></a></li>
			<li><a class="imgrotate" href="https://twitter.com/intent/tweet?source=<?php echo $recent['submitLink']; ?>&via=MendhamSC" target="_blank" title="Tweet" onclick="window.open('https://twitter.com/intent/tweet?text=Check+out+this+study+guide+<?php echo $recentLink; ?>&via=MendhamSC'); return false;"><img class="imgrotate" src="images/flat_web_icon_set/color/Twitter.png"></a></li>
			<li><a class="imgrotate" href="mailto:?subject=Study%20Central&body=<?php echo $recent['submitLink']; ?>" target="_blank" title="Email" onclick="window.open('mailto:?subject=' + encodeURIComponent(document.title) + '&body=' +  encodeURIComponent(document.URL)); return false;"><img class="imgrotate" src="images/flat_web_icon_set/color/Email.png"></a></li>
		  </ul>
        </td>
		</td>
		<?php
		$flagName = $recent['flag'];
		$submitTime = $recent['submitTime'];
		echo "<script>console.log('submit time is $submitTime');</script>";
		?>
        <td class="studyGuideFlagCol" id="studyGuideFlagCol"><?php if($flagName == "YES") {
		  //Flag Present
		  echo "<img title = 'This Study Guide has been flagged as innapropriate or irrelevant and is under review' class='hvr-buzz-out' src='inc/flags/report.png'>";
        } elseif ($flagName=="CLEAR") {
		  //Verified
		  echo "<img title='This Study Guide has been verified as safe' class='hvr-grow' src='inc/flags/safe.png'>";
		} else {
		  //No Flag, NOT Verified
		  echo "<a href ='flagStudy.php?studyGuide=$submitTime' style = 'background-color:#FFFFFF;color:#000000;text-decoration:none'><img title='Click to Flag this study guide as innapropriate or irrelevevant' class='hvr-float-shadow' src='inc/flags/yellow.png'></a>";
		}?>
	  </td>
      </tr><?php } ?>
    </table>
